...
import (
	...
	"github.com/okpulse/telegram-schedule-bot/internal/bot"
	"github.com/okpulse/telegram-schedule-bot/internal/config"
...
func main() {
	...
	if err := sch.RescheduleEnabledUsers(); err != nil {
		log.Println("reschedule:", err)
	}
